...
//  Weather SwiftUI
//
//  Created by Andrew Hoang on 2/17/22.
//
    ...
    var body: some View {
        ZStack(alignment: .leading) {
            ...
            VStack {
                ...
                .padding()
                .padding(.bottom, 20)
                .foregroundColor(Color(hue: 0.587, saturation: 0.938, brightness: 0.493))
                .background(.white)
                .cornerRadius(20, corners: [.topLeft, .topRight])
            }
        }
        .edgesIgnoringSafeArea(.bottom)
        .background(Color(hue: 0.587, saturation: 0.938, brightness: 0.493))
